...
head_external_d = 2.0;      // [1.0:0.01:5.0]
// Internal head diameter
head_internal_d = 0.75;      // [0.1:0.01:5.0]
// Head type.
...
// Flex diameter
flex_d = 1.25;               // [1.0:0.01:5.0]

/* [Body] */

// Notch distance from the tip of the swab
notch_d = 95.0;             // [5.0:1.0:150.0]
